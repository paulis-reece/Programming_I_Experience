...
int main() {
  ...
  // print out the "song"
  cout << "Enter an adjective: " << "Enter a noun: "<< "Enter another adjective: " << "Enter a command: " << "Enter a question word: " << "Enter a verb: " << "Enter a verb ending in 'ing': " << "Enter another adjective" << "Enter a preposition:";
